...
export const HubPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-background)] text-[var(--color-foreground)] flex flex-col items-center justify-center p-8 relative overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] right-[-10%] w-[30vw] h-[30vw] rounded-full bg-blue-500 opacity-5 blur-[100px] pointer-events-none" />
      ...
      >
        ...
        >
          {theme === 'dark' ? 'INIT SYSTEM' : theme === 'system' ? 'INIT LIGHT' : 'INIT DARK'}
        </button>
      </motion.header>
